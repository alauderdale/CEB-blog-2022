...
function boiler_setup() {
	...
	register_nav_menus( array(
		// 'footer-menu-company' => __( 'Footer company menu', 'boiler' ),
		// 'footer-menu-learn' => __( 'Footer learn menu', 'boiler' ),
		// 'footer-menu-platform' => __( 'Footer platform menu', 'boiler' ),
		// 'footer-menu-support' => __( 'Footer support menu', 'boiler' )
	) );
...
function boiler_scripts_styles() {
	...
	wp_enqueue_script( 'swiper', get_template_directory_uri() . '/js/lib/swiper.min.js', array(), '20120205', true );	

	wp_enqueue_script( 'boiler-main', get_template_directory_uri() . '/js/main.js', array(), '1', true );
